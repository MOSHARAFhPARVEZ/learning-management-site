...
<div class="page-content">
    ...
    @php
    $orderData = App\Models\Order::latest()->limit(5)->get();
    @endphp
        ...
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('admin.pending.order') }}">Pending Order</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('admin.confirm.order') }}">Confirm Order</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('uploads/course/course_image') }}/{{  $data->course->course_image }}"
                                    class="product-img-2" alt="product img"></td>
                            <td>{{  $data->course->category->category_name }}</td>
