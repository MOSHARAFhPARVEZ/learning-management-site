...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.coupon.update',$coupon->id) }}" method="POST"  class="row g-3">
                @csrf
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" class="form-controlr" name="coupon_validity" id="input2"  min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ $coupon->coupon_validity }}" >
                </div>
