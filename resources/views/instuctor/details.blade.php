        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{ (!empty($instuctor->photo)) ? url('uploads/instuctor_img/'.$instuctor->photo) : url('uploads/no_image.jpg') }}" alt="Student thumbnail image">
                </div>
                <div class="media-body">
                    <h2 class="section__title fs-30">{{ $instuctor->name }}</h2>

                    @if (!$instuctor->created_at == NULL)
                    <span class="d-block lh-18 pt-1 pb-2">Joined {{ $instuctor->created_at->format('d M Y') }}</span>
                    @endif

                    <p class="lh-18"> {{ $aboutins->position }} </p>
                    <p class="lh-18"> {{ $aboutins->bio }} </p>
                </div>
            </div><!-- end media -->
            <ul class="social-icons social-icons-styled social--icons-styled">
                <li><a href="{{ $aboutins->link_one }}"><i class="{{ $aboutins->social_one_icon }}"></i></a></li>
                <li><a href="{{ $aboutins->link_two }}"><i class="{{ $aboutins->social_two_icon }}"></i></a></li>
                <li><a href="{{ $aboutins->link_three }}"><i class="{{ $aboutins->social_three_icon }}"></i></a></li>
                <li><a href="{{ $aboutins->link_four }}"><i class="{{ $aboutins->social_four_icon }}"></i></a></li>
                <li><a href="{{ $aboutins->link_five }}"><i class="{{ $aboutins->social_five_icon }}"></i></a></li>
            </ul>
            ...
            <div class="tab-content pt-40px" id="myTabContent">
                <div class="tab-pane fade show active" id="about-me" role="tabpanel" aria-labelledby="about-me-tab">
                    <div class="card card-item">
                        <div class="card-body">
                            <p class="card-text pb-3">{{ $instuctor->description }}</p>
                            <div class="collapse" id="collapseReadMore">
                                <p class="card-text pb-3">{{ $instuctor->long_description }}.</p>
                            </div>
                ...
                <div class="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="experience-tab">
                    <div class="card card-item">
                        <div class="card-body">
                            <p>
                                {{ $aboutins->description }}
                            </p>
                            <div class="skills-wrap pt-30px">
                                <div class="skills">
                                    <div class="skill">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <span class="fs-16 text-black font-weight-semi-bold pr-3">{{ $aboutins->experience_one }}</span>
                                            <span>{{ $aboutins->experience_one_number }}%</span>
                                        </div>
                                    ...
                                    <div class="skill">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <span class="fs-16 text-black font-weight-semi-bold pr-3">{{ $aboutins->experience_two }}</span>
                                            <span>{{ $aboutins->experience_two_number }}%</span>
                                        </div>
                                        <div class="progress_bg">
                                            <div class="progress_bar"></div>
                                        </div>
                                    ...
                                    <div class="skill">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <span class="fs-16 text-black font-weight-semi-bold pr-3">{{ $aboutins->experience_three }}</span>
                                            <span>{{ $aboutins->experience_three_number }}%</span>
                                        </div>
                                        <div class="progress_bg">
                                            <div class="progress_bar"></div>
                                        </div>
                                    ...
                                    <div class="skill">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                                            <span class="fs-16 text-black font-weight-semi-bold pr-3">{{ $aboutins->experience_four }}</span>
                                            <span>{{ $aboutins->experience_four_number }}%</span>
                                        </div>
                                        <div class="progress_bg">
                                            <div class="progress_bar"></div>
                                        </div>
