                                        ...
                                        <ul>
                                            <li>
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid" src="{{ (!empty($profiledata->photo)) ? url('uploads/user_img/'.$profiledata->photo) : url('uploads/no_image.jpg') }}" alt="Avatar image">
                                                    </div>
                                                    <span class="dot-status bg-1"></span>
                                                </div>
                                                <ul class="cart-dropdown-menu after-none p-0 notification-dropdown-menu">
                                                    <li class="menu-heading-block d-flex align-items-center">
                                                        ...
                                                        <div class="ml-2">
                                                            <h4>
                                                                <a href="teacher-detail.html" class="text-black">
                                                                {{ $profiledata->name }}</a>
                                                            </h4>
                                                    ...
                                                    <li>
                                                        <ul class="generic-list-item">
                                                            ...
                                                            <li>
                                                                <a href="{{ route('user.profile.change') }}">
