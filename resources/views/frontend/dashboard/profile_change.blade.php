                    ...
                    <div class="setting-body">
                        ...
                        <div class="media media-card align-items-center">
                            <div class="media-img media-img-lg mr-4 bg-gray">
                                <img class="mr-3" src="{{ (!empty($profiledata->photo)) ? url('uploads/user_img/'.$profiledata->photo) : url('uploads/no_image.jpg') }}" alt="avatar image">
                            </div>
                            ...
                            <div class="input-box col-lg-6 pt-40px">
