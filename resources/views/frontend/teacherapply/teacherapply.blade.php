            ...
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <form action="{{ route('teacher.apply.store') }}" method="post" class="row">
                            @csrf
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid @enderror"
                                        type="text" name="name" placeholder="e.g. Smith">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-invalid @enderror"
                                        type="email" name="email" placeholder="e.g. alexsmith@gmail.com">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('address') is-invalid @enderror"
                                        type="text" name="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input id="phone" class="form-control form--control @error('phone') is-invalid @enderror" type="tel" name="phone" placeholder="e.g. 12345 =880 3647365">
                                    @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
