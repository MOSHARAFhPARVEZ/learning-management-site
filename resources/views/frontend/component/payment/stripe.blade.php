    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">Stripe Payment</h2>
            </div>
...
<!-- ///////////////////----------Start JavaScript for Stripe ------- /////////////////// -->

<script type="text/javascript">
    // Create a Stripe client.
var stripe = Stripe('pk_test_51Q5ogHKuaFjUPOvCVurF55PhThzgqHfSitGG1OIP6rEwG05dF0ygXtRRVF2dsvI8ugtPGVh6L8mFxZI4YsSvQHle00TCglGE3Q');
