...
@php
    $infos = App\Models\Sitesetting::latest()->get();
@endphp
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                ...
                <div class="footer-item">
                    <a href="index.html">
                        <img src="{{ asset('uploads/logo') }}/{{ $info->logo }}" alt="footer logo" class="footer__logo">
                    </a>
                    ...
                    <ul class="social-icons social-icons-styled">
                        <li class="mr-1"><a href="{{ $info->facebook }}" class="facebook-bg"><i class="la la-facebook"></i></a></li>
                        <li class="mr-1"><a href="{{ $info->twitter }}" class="twitter-bg"><i class="la la-twitter"></i></a></li>
                        <li class="mr-1"><a href="{{ $info->instragram }}" class="instagram-bg"><i class="la la-instagram"></i></a></li>
                        <li class="mr-1"><a href="{{ $info->linkedin }}" class="linkedin-bg"><i class="la la-linkedin"></i></a></li>
                    </ul>
                </div><!-- end footer-item -->
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="generic-list-item">
                        ...
                        <li><a href="{{ route('teacher.apply') }}">Become a Teacher</a></li>
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; {{ $info->copyright }} <a href="https://techydevs.com/">TechyDevs</a></p>
                </div><!-- end col-lg-6 -->
